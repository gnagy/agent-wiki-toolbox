 ...
 * parser, its own address and its own hazards — and the body, addressed by
 * segment path, which is the other half of that split.
 *
...
export {body, BODY_CODES} from './lib/body.js'
